...
function AlertModal(props) {
    ...
    */
    ...
    return (
        <Fragment>
            <div className="fixed z-50 top-16 pt-12 bg-transparent h-screen w-full flex justify-center " onClick={modalClose}>
                <div className="relative w-11/12 sm:w-96 h-fit bg-white  rounded-lg shadow bg-slate-200" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="p-6 text-center">
                        ...
                        <button data-modal-hide="popup-modal" type="button" className="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600" onClick={modalClose}>{type === 'warning' ? 'Cancel' : 'Ok'}</button>
                    </div>
                </div>
            </div>
        </Fragment>
